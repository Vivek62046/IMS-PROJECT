...
class billClass:
    def __init__(self,root):
        ...
        self.icon_title=PhotoImage(file=r"C:\Users\DELL\Desktop\Inventory-Management-System-main\images\logo1.png")
        ...
        #------------ footer -----------------
        lbl_footer=Label(self.root,text="IMS-Inventory Management System | Developed by Deepak Kumar Singh\nFor any Technical Issues Contact: 9523941328",font=("times new roman",10),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#---------------------- all functions ------------------------------
    ...
    def generate_bill(self):
        if self.var_cname.get()=="" or self.var_contact.get()=="":
            ...
            fp=open(rf'C:\Users\DELL\Desktop\Inventory-Management-System-main\bill/{str(self.invoice)}.txt','w')
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tABCD(Ajit Bablu Chandan Deepak)-Inventory
\t Phone No. 9523941328 , Bihar-802117
{str("="*46)}
